...
class PetFriends:
    ...
    def __init__(self): #инициализация по url
    ...
    def post_add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет на сервер запрос на добавление питомца и данные этого питомца и возвращает статус
    ...
    def put_update_pet_info(self, auth_key: json, pet_id: str, name: str,
    ...
    def post_add_new_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод отправляет на сервер запрос на добавление питомца без фото и данные этого питомца
         и возвращает статус запроса и результат в формате JSON с данными питомца"""
    ...
    def post_add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер запрос и данные для добавления нового фото питомца и возвращает статус
        запроса и результат в формате JSON с данными питомца"""
